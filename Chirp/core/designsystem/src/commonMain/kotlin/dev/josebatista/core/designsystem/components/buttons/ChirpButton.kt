package dev.josebatista.core.designsystem.components.buttons
...
@Preview
@Composable
private fun ChirpPrimaryButtonPreviewLightTheme() {
    ChirpTheme(
        darkTheme = false
    ) {
        ChirpButton(
...
@Preview
@Composable
private fun ChirpSecondaryButtonPreviewLightTheme() {
    ChirpTheme(
        darkTheme = false
    ) {
        ChirpButton(
...
@Preview
@Composable
private fun ChirpDestructivePrimaryButtonPreviewLightTheme() {
    ChirpTheme(
        darkTheme = false
    ) {
        ChirpButton(
...
@Preview
@Composable
private fun ChirpDestructiveSecondaryButtonPreviewLightTheme() {
    ChirpTheme(
        darkTheme = false
    ) {
        ChirpButton(
...
@Preview
@Composable
private fun ChirpTextButtonPreviewLightTheme() {
    ChirpTheme(
        darkTheme = false
    ) {
        ChirpButton(
...
@Preview
@Composable
private fun ChirpPrimaryButtonPreviewDarkTheme() {
    ChirpTheme(
        darkTheme = true
    ) {
        ChirpButton(
...
@Preview
@Composable
private fun ChirpSecondaryButtonPreviewDarkTheme() {
    ChirpTheme(
        darkTheme = true
    ) {
        ChirpButton(
...
@Preview
@Composable
private fun ChirpDestructivePrimaryButtonPreviewDarkTheme() {
    ChirpTheme(
        darkTheme = true
    ) {
        ChirpButton(
...
@Preview
@Composable
private fun ChirpDestructiveSecondaryButtonPreviewDarkTheme() {
    ChirpTheme(
        darkTheme = true
    ) {
        ChirpButton(
...
@Preview
@Composable
private fun ChirpTextButtonPreviewDarkTheme() {
    ChirpTheme(
        darkTheme = true
    ) {
        ChirpButton(
