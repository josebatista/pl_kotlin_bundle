...
@Composable
private fun ChirpPasswordTextFieldEmptyLightThemePreview() {
    ChirpTheme {
...
@Preview(showBackground = true)
@Composable
private fun ChirpPasswordTextFieldFilledLightThemePreview() {
    ChirpTheme {
        ChirpPasswordTextField(
...
@Preview(showBackground = true)
@Composable
private fun ChirpPasswordTextFieldErrorLightThemePreview() {
    ChirpTheme {
        ChirpPasswordTextField(
            state = rememberTextFieldState("password123"),
            isPasswordVisible = true,
...
@Preview(showBackground = true)
@Composable
private fun ChirpPasswordTextFieldEmptyDarkThemePreview() {
...
@Preview(showBackground = true)
@Composable
private fun ChirpPasswordTextFieldFilledDarkThemePreview() {
    ChirpTheme(darkTheme = true) {
        ChirpPasswordTextField(
            state = rememberTextFieldState("password123"),
            isPasswordVisible = false,
...
@Preview(showBackground = true)
@Composable
private fun ChirpPasswordTextFieldErrorDarkThemePreview() {
    ChirpTheme(darkTheme = true) {
        ChirpPasswordTextField(
            state = rememberTextFieldState("password123"),
            isPasswordVisible = true,
