...
import chirp.feature.auth.presentation.generated.resources.forgot_password_email_sent_succefully
import chirp.feature.auth.presentation.generated.resources.submit
import dev.josebatista.core.designsystem.components.brand.ChirpBrandLogo
import dev.josebatista.core.designsystem.components.buttons.ChirpButton
import dev.josebatista.core.designsystem.components.layouts.ChirpAdaptiveFormLayout
import dev.josebatista.core.designsystem.components.textfields.ChirpTextField
...
private fun ForgotPasswordScreen(
    ...
    ChirpAdaptiveFormLayout(
        ...
        if (state.isEmailSentSuccessfully) {
            Text(
                text = stringResource(Res.string.forgot_password_email_sent_succefully),
